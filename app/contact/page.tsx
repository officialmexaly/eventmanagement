...
export default function ContactPage() {
  ...
  const contactMethods = [
    ...
    },
    {
      icon: MapPin,
      title: 'Visit Us',
      content: '123 Event Street, Lagos, Nigeria',
  ...
  const supportCategories = [
    ...
    },
    {
      icon: Headphones,
      title: 'Event Support',
      description: 'Questions about specific events',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-purple-600 via-indigo-600 to-purple-700 text-white py-20">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-lg font-semibold hover:shadow-lg transition-all flex items-center justify-center gap-2"
                >
        ...
        <div className="mt-12 bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="bg-gray-200 h-96 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">123 Event Street, Lagos, Nigeria</p>
            </div>
          </div>
        </div>
      </div>
